...
import { GiSkills, GiPaintBrush } from "react-icons/gi"
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            ...
            >
                ...
                {/* Toggle Drawing/Coding Mode Button */}
                <div className="flex h-fit items-center justify-center">
                    <button
                        className="flex items-center justify-center rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 p-2 text-white shadow-lg hover:from-blue-800 hover:to-blue-600 transition-all"
                        onClick={changeState}
