...
function FilesView() {
    ...
    return (
        <div
            className="flex select-none flex-col gap-3 px-5 py-4"
            style={{
                height: viewHeight,
                maxHeight: viewHeight,
                backgroundColor: "#0b0f19", // deep black-blue
                color: "#ffffff",
        ...
        >
            ...
            <div
                className={cn(
                    "flex min-h-fit flex-col justify-end pt-4 transition-all duration-300",
                    { hidden: minHeightReached }
                )}
            >
                <hr className="border-blue-900 mb-3" />
    
                <button
                    className="flex items-center gap-3 rounded-xl px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg hover:brightness-110 transition-all duration-300"
                ...
                <button
                    className="mt-3 flex items-center gap-3 rounded-xl px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg hover:brightness-110 transition-all duration-300"
