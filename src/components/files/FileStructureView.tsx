...
function FileStructureView() {
    ...
    return (
        ...
        >
            {/* Header Title */}
            <div className="view-title flex items-center justify-between px-4 py-3 border-b border-blue-900 shadow-sm">
                <h2 className="text-lg font-semibold text-white tracking-wide">Files</h2>
    
                {/* Action Buttons */}
                <div className="flex gap-2">
                    <button
                        className="rounded-md p-2 bg-blue-600 hover:bg-blue-700 transition duration-200 shadow-md"
                        onClick={handleCreateFile}
                        title="Create File"
                    >
                        <RiFileAddLine className="text-white" size={20} />
                    </button>
                    <button
                        className="rounded-md p-2 bg-indigo-600 hover:bg-indigo-700 transition duration-200 shadow-md"
                        onClick={handleCreateDirectory}
                        title="Create Directory"
                    >
                        <RiFolderAddLine className="text-white" size={20} />
                    </button>
                    <button
                        className="rounded-md p-2 bg-emerald-600 hover:bg-emerald-700 transition duration-200 shadow-md"
                        onClick={collapseDirectories}
                        title="Collapse All Directories"
                    >
                        <RiFolderUploadLine className="text-white" size={20} />
                    </button>
                </div>
            </div>
